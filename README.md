...
Default target: the local Qwen server at `http://127.0.0.1:19434/v1`. On David's machine the preferred server is one dual-slot llama.cpp process across both RTX 3090s: `--ctx-size 524288 -np 2`, reported as two simultaneous `n_ctx=262144` slots.
